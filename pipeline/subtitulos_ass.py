...
def generar(edl: dict, transcripcion: dict, layout: dict, perfil: Perfil, estilo: str | None = None) -> str:
    ...
    for k, b in enumerate(grupos):
        ...
        for j, w in enumerate(b):
            ...
            partes = [(f"{{\\c{acento}}}{t}{{\\c{blanco}}}" if i == j else t) for i, t in enumerate(textos)]
